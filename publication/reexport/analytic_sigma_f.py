...
Замечание руководителя (14.09.2026): деформацию и скорость деформации можно
получить из соотношений и подставить в уравнение состояния; вопрос только в
оценке температуры.

Ответ: температура не требует отдельного источника, она замыкается на само
...
ПРОВЕРКА. Оценка разогрева сверена с измеренной: аналитические 13-17 К против
