...
\begin{figure*}[h!]
    ...
    \caption{Training of the data-driven MLP surrogate. The architecture and every
...
\begin{figure*}[h!]
    ...
    \caption{Training of the physics-informed surrogate: shared trunk, equilibrium
...
\begin{table*}[htbp]
\centering\small
\caption{Drawing stress (MPa) for the four runs: the finite-element value against the Siebel
